...
module.exports = (app) => {
  ...
  app.post("/cutomerdownlist", product_com.cutomerProductlist); //post
  app.post("/cutomerrecentlist", product_com.cutomerrecentlist); //post
  ...
  app.post("/customerupdaterole", customercon.updaterole);  
  app.post("/customeredit", customercon.edit);
  app.post("/customersearch", customercon.searchany); //get
  app.delete("/customerdelete/:id", customercon.comdelete);  

  app.post("/customerupdate", customercon.update);
  app.get("/customerfind/:id", customercon.findone);
